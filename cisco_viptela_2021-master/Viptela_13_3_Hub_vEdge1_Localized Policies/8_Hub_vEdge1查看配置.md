 ...
 router
  bgp 140
   ...
   neighbor 172.16.41.1
    ...
    ebgp-multihop 255
    address-family ipv4-unicast
     route-policy Hub_vEdge1_140_to_4_Out out
    !
   !
 ...
 router
  bgp 40
   ...
   neighbor 10.1.41.1
    ...
    ebgp-multihop 255
    address-family ipv4-unicast
     route-policy Hub_vEdge1_40_to_4_Out out
    !
   !
  !
 !
...
---------------------------------------------------------------------------------------------------------
172.16.41.1      4     1521      1386      0      0:22:49:18       1       1       1          established
172.16.141.254   254   1378      1374      0      0:22:49:18       10      10      10         established
...
NEIGHBOR         AS    RCVD      SENT      Q      UPTIME           RCVD    VALID   INSTALLED  STATE      
---------------------------------------------------------------------------------------------------------
10.1.41.1        4     1536      1376      0      0:22:49:14       12      12      12         established
```